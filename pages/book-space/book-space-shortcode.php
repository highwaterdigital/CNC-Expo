        ...
        <div class="cnc-map-card">
            ...
            <div class="cnc-grid">
                ...
                <?php foreach($stalls as $s): 
                    ...
                    // Custom Color Logic (Only for Available stalls or Features)
                    $has_custom_color = !empty($s['custom_color']);
                    if ($has_custom_color && ($s['status'] === 'available' || $s['type'] === 'feature')) {
                        $style .= " background-color: " . esc_attr($s['custom_color']) . "; border-color: " . esc_attr($s['custom_color']) . ";";
                    }
                ...
                ?>
                    <div class="<?php echo $classes; ?>"
                        ...
                        if ($s['status'] === 'available' && $s['type'] === 'stall'): ?>
